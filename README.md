...
├── patterns/                    # Production patterns (56 core + 45 stack-specific + 1 marketing + 2 finance + 2 legal)
...
│   ├── cross-layer/             # Cross-layer patterns (11 patterns)
...
**Key Documentation**:
- `patterns/README.md` — Full pattern index (106 patterns)
